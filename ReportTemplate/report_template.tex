...
\begin{titlepage} % Suppresses displaying the page number on the title page and the subsequent page counts as page 1
    ...
    {\huge\bfseries Module Level Outcome: \emph{Insert MLO here}}\\[0.4cm] % Title
	...
	\vfill\vfill
	\includegraphics[width=0.5\textwidth]{robosub_logo.png}\\[1cm] % Include a department/university logo - this will require the graphicx package
